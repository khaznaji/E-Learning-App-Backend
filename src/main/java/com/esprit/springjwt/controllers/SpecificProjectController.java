    ...
    public SpecificProject create( /**Optional**/ @RequestParam(value ="files", required = false) MultipartFile[] files,
        ...
        try {
            ...
            if (video != null && !video.isEmpty()) {
                ...
                String videoDestinationPath = "C:\\Users\\DELL\\Desktop\\The Bridge Front\\9antraFormationFrant\\src\\assets\\SpecificProject\\" + titre + "_" + savedFood.getId() + "\\";
            ...
            String imageDestinationPath = "C:\\Users\\DELL\\Desktop\\The Bridge Front\\9antraFormationFrant\\src\\assets\\SpecificProject\\" + titre + "_" + savedFood.getId() + "\\";
