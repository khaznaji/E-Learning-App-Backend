...
group.setCertificatesGenerated(false);
            ...
            for (User user : users) {
                ...
                for (Certificat certificat : certificats) {
                    String pathToDelete = "C:\\Users\\DELL\\Desktop\\The Bridge Front\\9antraFormationFrant\\src\\assets\\Certifications\\" + nom_formation + " " + certificat.getMonth();
            ...
            for (User user : users) {
                ...
                for (Certificat certificat : certificats) {
                    ...
                    if (!month.equals(certificat.getMonth())) {
                        ...
                        File oldFolder = new File("C:\\Users\\DELL\\Desktop\\The Bridge Front\\9antraFormationFrant\\src\\assets\\" + oldPath).getParentFile();
        ...
        try {
            ...
            for (Certificat certificat : certificats) {
                ...
                if (!month.equals(certificat.getMonth())) {
                    ...
                    File oldFile = new File("C:\\Users\\DELL\\Desktop\\The Bridge Front\\9antraFormationFrant\\src\\assets\\" + oldPath);
...
/****** periode tetmodifa ***/
    ...
    public ResponseEntity<String> modifierCertificatsForGroupUpdatePeriode(@PathVariable Long idgroupe, @RequestParam String newPeriode, @RequestParam String newMonth) {
        try {
            ...
            for (User user : users) {
                ...
                String pdfname = "C:\\Users\\DELL\\Desktop\\The Bridge Front\\9antraFormationFrant\\src\\assets\\" + relativePath;
                File f = new File("C:\\Users\\DELL\\Desktop\\The Bridge Front\\9antraFormationFrant\\src\\assets\\Certifications\\" + nom_formation + " " + newMonth);
    ...
    public ResponseEntity<String> supprimerUserFromGroup(@PathVariable Long idgroupe, @PathVariable Long iduser) {
        try {
            ...
            List<Certificat> certificats = certificatRepository.findByUser(user);
            for (Certificat certificat : certificats) {
                String pdfPathToDelete = "C:\\Users\\DELL\\Desktop\\The Bridge Front\\9antraFormationFrant\\src\\assets\\" + certificat.getPath();
